package cn.adair.oxframe.statusbar;
...
import cn.adair.oxframe.utils.OSUtil;

/**
 * @ClassName: OxStatusBar
 * @Package: cn.adair.oxframe.statusbar
 * @Description: 沉浸式状态栏
 * @Author: Adair
...
public class OxStatusbar {
    ...
    public static boolean supportTransparentStatusBar() {
        return OSUtil.isMiui() || OSUtil.isFlyme() || (OSUtil.isOppo() && Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) || Build.VERSION.SDK_INT >= Build.VERSION_CODES.M;
    }
