package cn.adair.oxframe.utils;
...
public class KeyboardCompat {
    ...
    public static void assistWindow(Window window) {
        new KeyboardCompat(window);
    }

    private KeyboardCompat(Window window) {
        ...
        statusBarHeight = OxStatusbar.getStatusBarHeight(window.getContext());
    }
