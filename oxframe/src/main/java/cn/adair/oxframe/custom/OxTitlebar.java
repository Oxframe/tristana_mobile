package cn.adair.oxframe.custom;
...
import cn.adair.oxframe.utils.ScreenUtil;
...
public class OxTitlebar extends RelativeLayout implements View.OnClickListener {
    ...
    public OxTitlebar(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    private void loadAttributes(Context context, AttributeSet attrs) {
        ...
        TypedArray array = context.obtainStyledAttributes(attrs, R.styleable.OxTitlebar);

        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
            // notice 未引入沉浸式标题栏之前,隐藏标题栏撑起布局
            fillStatusBar = array.getBoolean(R.styleable.OxTitlebar_fillStatusBar, true);
        }
        titleBarColor = array.getColor(R.styleable.OxTitlebar_titleBarColor, Color.parseColor("#ffffff"));
        titleBarHeight = (int) array.getDimension(R.styleable.OxTitlebar_titleBarHeight, ScreenUtil.dp2PxInt(context, 44));
        statusBarColor = array.getColor(R.styleable.OxTitlebar_statusBarColor, Color.parseColor("#ffffff"));
        statusBarMode = array.getInt(R.styleable.OxTitlebar_statusBarMode, 0);

        showBottomLine = array.getBoolean(R.styleable.OxTitlebar_showBottomLine, true);
        bottomLineColor = array.getColor(R.styleable.OxTitlebar_bottomLineColor, Color.parseColor("#dddddd"));
        bottomShadowHeight = array.getDimension(R.styleable.OxTitlebar_bottomShadowHeight, ScreenUtil.dp2PxInt(context, 0));

        leftType = array.getInt(R.styleable.OxTitlebar_leftType, TYPE_LEFT_NONE);
        if (leftType == TYPE_LEFT_TEXTVIEW) {
            leftText = array.getString(R.styleable.OxTitlebar_leftText);
            leftTextColor = array.getColor(R.styleable.OxTitlebar_leftTextColor, getResources().getColor(R.color.comm_titlebar_text_selector));
            leftTextSize = array.getDimension(R.styleable.OxTitlebar_leftTextSize, ScreenUtil.dp2PxInt(context, 16));
            leftDrawable = array.getResourceId(R.styleable.OxTitlebar_leftDrawable, 0);
            leftDrawablePadding = array.getDimension(R.styleable.OxTitlebar_leftDrawablePadding, 5);
        } else if (leftType == TYPE_LEFT_IMAGEBUTTON) {
            leftImageResource = array.getResourceId(R.styleable.OxTitlebar_leftImageResource, R.drawable.comm_titlebar_reback_selector);
        } else if (leftType == TYPE_LEFT_CUSTOM_VIEW) {
            leftCustomViewRes = array.getResourceId(R.styleable.OxTitlebar_leftCustomView, 0);
        }

        rightType = array.getInt(R.styleable.OxTitlebar_rightType, TYPE_RIGHT_NONE);
        if (rightType == TYPE_RIGHT_TEXTVIEW) {
            rightText = array.getString(R.styleable.OxTitlebar_rightText);
            rightTextColor = array.getColor(R.styleable.OxTitlebar_rightTextColor, getResources().getColor(R.color.comm_titlebar_text_selector));
            rightTextSize = array.getDimension(R.styleable.OxTitlebar_rightTextSize, ScreenUtil.dp2PxInt(context, 16));
        } else if (rightType == TYPE_RIGHT_IMAGEBUTTON) {
            rightImageResource = array.getResourceId(R.styleable.OxTitlebar_rightImageResource, 0);
        } else if (rightType == TYPE_RIGHT_CUSTOM_VIEW) {
            rightCustomViewRes = array.getResourceId(R.styleable.OxTitlebar_rightCustomView, 0);
        }

        centerType = array.getInt(R.styleable.OxTitlebar_centerType, TYPE_CENTER_NONE);
        if (centerType == TYPE_CENTER_TEXTVIEW) {
            centerText = array.getString(R.styleable.OxTitlebar_centerText);
            centerTextColor = array.getColor(R.styleable.OxTitlebar_centerTextColor, Color.parseColor("#333333"));
            centerTextSize = array.getDimension(R.styleable.OxTitlebar_centerTextSize, ScreenUtil.dp2PxInt(context, 18));
            centerTextMarquee = array.getBoolean(R.styleable.OxTitlebar_centerTextMarquee, true);
            centerSubText = array.getString(R.styleable.OxTitlebar_centerSubText);
            centerSubTextColor = array.getColor(R.styleable.OxTitlebar_centerSubTextColor, Color.parseColor("#666666"));
            centerSubTextSize = array.getDimension(R.styleable.OxTitlebar_centerSubTextSize, ScreenUtil.dp2PxInt(context, 11));
        } else if (centerType == TYPE_CENTER_SEARCHVIEW) {
            centerSearchEditable = array.getBoolean(R.styleable.OxTitlebar_centerSearchEditable, true);
            centerSearchBgResource = array.getResourceId(R.styleable.OxTitlebar_centerSearchBg, R.drawable.comm_titlebar_search_gray_shape);
            centerSearchRightType = array.getInt(R.styleable.OxTitlebar_centerSearchRightType, TYPE_CENTER_SEARCH_RIGHT_VOICE);
        } else if (centerType == TYPE_CENTER_CUSTOM_VIEW) {
            centerCustomViewRes = array.getResourceId(R.styleable.OxTitlebar_centerCustomView, 0);
        }
    ...
    private void initGlobalViews(Context context) {
        ...
        boolean transparentStatusBar = OxStatusbar.supportTransparentStatusBar();

        // 构建标题栏填充视图
        if (fillStatusBar && transparentStatusBar) {
            int statusBarHeight = OxStatusbar.getStatusBarHeight(context);
            viewStatusBarFill = new View(context);
            viewStatusBarFill.setId(OxStatusbar.generateViewId());
        ...
        rlMain.setId(OxStatusbar.generateViewId());
    ...
    private void initMainLeftViews(Context context) {
        ...
        if (leftType == TYPE_LEFT_TEXTVIEW) {
            ...
            tvLeft.setId(OxStatusbar.generateViewId());
            ...
            btnLeft.setId(OxStatusbar.generateViewId());
            ...
            if (viewCustomLeft.getId() == View.NO_ID) {
                viewCustomLeft.setId(OxStatusbar.generateViewId());
            }
    ...
    private void initMainRightViews(Context context) {
        ...
        if (rightType == TYPE_RIGHT_TEXTVIEW) {
            ...
            tvRight.setId(OxStatusbar.generateViewId());
            ...
            btnRight.setId(OxStatusbar.generateViewId());
            ...
            if (viewCustomRight.getId() == View.NO_ID) {
                viewCustomRight.setId(OxStatusbar.generateViewId());
            }
    ...
    private void initMainCenterViews(Context context) {
        if (centerType == TYPE_CENTER_TEXTVIEW) {
            ...
            llMainCenter.setId(OxStatusbar.generateViewId());
            ...
            ivSearch.setId(OxStatusbar.generateViewId());
            ...
            ivVoice.setId(OxStatusbar.generateViewId());
            ...
            if (centerCustomView.getId() == View.NO_ID) {
                centerCustomView.setId(OxStatusbar.generateViewId());
            }
...
//            }
    ...
    private void setUpImmersionTitleBar() {
        ...
        // 设置状态栏背景透明
        OxStatusbar.transparentStatusBar(window);
        // 设置图标主题
        if (statusBarMode == 0) {
            OxStatusbar.setDarkMode(window);
        } else {
            OxStatusbar.setLightMode(window);
        }
    }
    ...
    public void setLeftView(View leftView) {
        if (leftView.getId() == View.NO_ID) {
            leftView.setId(OxStatusbar.generateViewId());
        }
        LayoutParams leftInnerParams = new LayoutParams(WRAP_CONTENT, MATCH_PARENT);
        leftInnerParams.addRule(RelativeLayout.ALIGN_PARENT_START);
        leftInnerParams.addRule(RelativeLayout.CENTER_VERTICAL);
    ...
    public void setCenterView(View centerView) {
        if (centerView.getId() == View.NO_ID) {
            centerView.setId(OxStatusbar.generateViewId());
        }
    ...
    public void setRightView(View rightView) {
        if (rightView.getId() == View.NO_ID) {
            rightView.setId(OxStatusbar.generateViewId());
        }
        LayoutParams rightInnerParams = new LayoutParams(WRAP_CONTENT, MATCH_PARENT);
        rightInnerParams.addRule(RelativeLayout.ALIGN_PARENT_END);
        rightInnerParams.addRule(RelativeLayout.CENTER_VERTICAL);
