...
public class LaunchActivitya extends SwipeBackActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        titleBar.setListener(new OxTitlebar.OnTitleBarListener() {
            ...
            public void onClicked(View v, int action, String extra) {
                if (action == OxTitlebar.ACTION_RIGHT_TEXT) {
        ...
        lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                if (position == 0) {
                    startActivity(new Intent(LaunchActivitya.this, QuickPreviewActivity.class));
                } else {
                    Intent intent = new Intent(LaunchActivitya.this, MainActivity.class);
